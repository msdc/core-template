...
import com.isoftstone.crawl.template.IComponent.ISelectorHandler;
...
//						}	
						...
						if(!exists)
							parseResult.setResult(Constants.CONTENT_OUTLINK + "_"+ (j + outlinkLength), resultVale);
						else
						{
			...
			LOG.error("The page " + url
					+ " , the selector CONTENT_OUTLINK the index is null.");
			return -1;
		}
	}
}
