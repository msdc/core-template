...
//		
		url = "http://www.ebnew.com/businessShow-v-id-489274874.html";
	...
	public static TemplateResult EbnuwTemplate()
	{
		...
		indexer = new SelectorIndexer();
		selector = new Selector();
		indexer.initJsoupIndexer("body > div.sj-search > div.sj-search-jg > div.coun.float_lt > span > strong",
		...
		selector.initPagitationSelector(Constants.PAGINATION_TYPE_PAGERECORD,
				"##", "",
				"http://www.ebnew.com/tradingIndex.view?key=&pubDateBegin=&pubDateEnd=&infoType=&fundSourceCodes=&zone=&normIndustry=&bidModel=&timeType=&sortMethod=&currentPage=##&length=40", "2", "40",
				indexer, filter, null);
