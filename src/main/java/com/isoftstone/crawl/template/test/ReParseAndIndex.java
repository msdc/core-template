...
public class ReParseAndIndex {
	public static void main(String[] args) {
		if (args.length < 4) {
			System.err.println("Usage: ParseAndIndex <nutch_root> <data_folder> <solr_index> <parse_filter>");
			return;
		}
		...
		reParseAndIndex(nutch_root, data_folder, solr_index, Boolean.parseBoolean(filter));
	}
