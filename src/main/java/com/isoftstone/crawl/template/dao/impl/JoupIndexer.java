...
import com.isoftstone.crawl.template.dao.TIndexerHandler;
 ...
 * 
 */
public class JoupIndexer implements TIndexerHandler {
	private static final Log LOG = LogFactory.getLog(JoupIndexer.class);
	private SelectorIndexer index = null;

	public JoupIndexer() {
	}

	public JoupIndexer(SelectorIndexer index) {
		this.index = index;
	}
